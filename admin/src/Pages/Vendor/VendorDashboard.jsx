...
const VendorDashboard = () => (
  <div className="p-6 bg-white rounded-xl shadow-sm">
    <h2 className="text-2xl font-bold mb-4 text-purple-700">Vendor Dashboard</h2>
    ...
    <div className="text-gray-600">
      <p>Welcome to your vendor dashboard. Please review the above terms and ensure compliance to continue using our platform.</p>
    </div>
  </div>
);
