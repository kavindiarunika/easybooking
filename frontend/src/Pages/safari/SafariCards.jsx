  ...
  return (
    <div>
      ...
      <div className="flex flex-row gap-4 mb-6">
        <select
          className="px-4 py-2 rounded-lg border border-gray-300 bg-green-200 text-gray-800 font-medium"
          value={sortprice}
          onChange={(e) => {
        ...
        >
          ...
          <option value="lowtohigh">Members: Low to High</option>
          <option value="hightolow">Members: High to Low</option>
        </select>
      </div>
